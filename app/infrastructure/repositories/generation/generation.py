...
class GeneratedImageRepository(CRUDRepository[GeneratedImage, GeneratedImageCreate, GeneratedImageUpdate]):
    ...
    def report_all_in(self, id_list: List[int]) -> bool:
        stmt = update(GeneratedImage).where(GeneratedImage.id.in_(id_list)).values(reported=True)
        self.db.execute(stmt)
        return True
...
class GeneratedImageGroupRepository(CRUDRepository[GeneratedImageGroup, GeneratedImageGroupCreate, GeneratedImageGroupUpdate]):
    ...
    def get_all_by_user(self, user_id: int) -> List[GeneratedImageGroup]:
        stmt = select(GeneratedImageGroup).where(
            ...
            GeneratedImageGroup.reported == False,
    ...
    def report(self, generated_image_group_id: int) -> bool:
        stmt = update(GeneratedImageGroup).where(GeneratedImageGroup.id == generated_image_group_id).values(reported=True)
        self.db.execute(stmt)
        return True
